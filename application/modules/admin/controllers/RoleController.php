...
class Admin_RoleController extends Zend_Controller_Action
{
    ...
    public function editerAction()
    {
        ...
        $roleForm->parent_id->setMultiOptions($roleParentOptions);
            ...
            if ($formIsValid) {
                try {
                    ...
                    if (empty($res)) {
                        ...
                        $this->_helper->flashMessengerStatus->addMessageStatus('role_save_ok', App_View_Helper_Alert::STATUS_SUCCESS);                        
